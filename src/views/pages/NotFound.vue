        ...
        <div class="flex flex-col items-center justify-center">
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, color-mix(in srgb, var(--primary-color), transparent 60%) 10%, var(--surface-ground) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 flex flex-col items-center" style="border-radius: 53px">
                    ...
                    <h1 class="text-surface-900 dark:text-surface-0 font-bold text-3xl lg:text-5xl mb-2">페이지를 찾을 수 없습니다.</h1>
                    <div class="text-surface-600 dark:text-surface-200 mb-8">요청하신 리소스를 사용할 수 없습니다.</div>
                    <router-link to="/" class="w-full flex items-center py-8 border-surface-300 dark:border-surface-500 border-b">
                        ...
                        <span class="ml-6 flex flex-col">
                            <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0 block">자주 묻는 질문</span>
                            <span class="text-surface-600 dark:text-surface-200 lg:text-xl">왜 페이지 이동이 안되나요?</span>
                        </span>
                    </router-link>
                    <router-link to="/" class="w-full flex items-center py-8 border-surface-300 dark:border-surface-500 border-b">
                        <span class="flex justify-center items-center border-2 border-primary text-primary rounded-border" style="height: 3.5rem; width: 3.5rem">
                        ...
                        <span class="ml-6 flex flex-col">
                            <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0">고객 지원 센터</span>
                            <span class="text-surface-600 dark:text-surface-200 lg:text-xl">기술지원이 필요하신가요?</span>
                        </span>
                    </router-link>
                    <router-link to="/" class="w-full flex items-center mb-8 py-8 border-surface-300 dark:border-surface-500 border-b">
                        ...
                        <span class="ml-6 flex flex-col">
                            <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0">권환관리자</span>
                            <span class="text-surface-600 dark:text-surface-200 lg:text-xl">당신은 해당 페이지에 권한이 있나요?</span>
                        </span>
                    </router-link>
                    <Button as="router-link" label="메인페이지로 이동" to="/dashboard" />
                </div>
            </div>
        </div>
    </div>
